...
os.chdir(r"E:\Anaconda\Spyder\Sign-Language-to-Text-master\Sign-Language-to-Text-master\model") #\model
print(os.getcwd())

class Application:
    def __init__(self):
        self.directory = ""
        self.hs = hunspell.Hunspell('/usr/share/hunspell/en_US', '/usr/share/hunspell/en_US.aff')
        ...
        self.json_file_dru = open(self.directory+"model-bw.json" , "r") # model-bw_dru.json tha
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights("model-bw.h5")   # model-bw_dru.h5

        self.json_file_tkdi = open(self.directory+"model-bw.json" , "r")   # model-bw_tkdi.json
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights(self.directory+"model-bw.h5")  # model-bw_tkdi.json

        self.json_file_smn = open(self.directory+"model-bw.json" , "r")    # model-bw_smn.json
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights(self.directory+"model-bw.h5")    # model-bw_smn.h5
        ...
        self.root.geometry("700x600")   #900x1100
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            predicts=self.hs.suggest(self.word)          #   /LOOk it up
            if(len(predicts) > 0):
    ...
    def action_call(self) :
        ...
        self.tx6.config(text = "Akankshya\1801109022", font = ("Courier",15,"bold"))
        ...
        self.tx2.config(text = "Amit\1801109044", font = ("Courier",15,"bold"))
        ...
        self.tx3.config(text = "Bipin\1801109094", font = ("Courier",15,"bold"))
        ...
        self.tx6.config(text = "Dr. Niranjan Panigrahi ", font = ("Courier",30,"bold"))
